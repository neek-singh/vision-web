...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-white/80 backdrop-blur-2xl text-black py-12 mt-auto rounded-t-3xl border-t border-white shadow-[0_-10px_40px_-15px_rgba(0,0,0,0.05)] overflow-hidden z-10">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 z-10">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 lg:gap-6">
          ...
          <div className="md:col-span-1">
            ...
            >
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] font-black text-slate-800 tracking-wider mt-1 uppercase">
                  Computer Institute <span className="text-blue-600">Pratappur</span>
                </span>
              </div>
            </Link>

            <p className="mt-4 text-xs md:text-sm text-black max-w-sm leading-relaxed font-medium">
          ...
          {/* Popular Courses */}
          <div>
            <h4 className="text-sm font-bold text-gray-900 mb-4">Popular Courses</h4>
          ...
          {/* Programs & Batches */}
          <div>
            <h4 className="text-sm font-bold text-gray-900 mb-4">Programs</h4>
            <ul className="space-y-2">
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-sm font-bold text-gray-900 mb-4">Reach Out</h4>

            <ul className="space-y-3 text-xs text-black font-medium">
              <li className="flex items-start gap-2.5 group">
                <div className="mt-0.5 p-1.5 rounded-lg bg-blue-50 border border-blue-100 text-blue-600 group-hover:bg-blue-600 group-hover:text-white transition-all shadow-sm shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <rect width="20" height="16" x="2" y="4" rx="2" /><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7" />
                  </svg>
                </div>
                <span className="mt-0.5 group-hover:text-blue-600 transition-colors break-all">{contact.email}</span>
              </li>
              ...
              <li className="flex items-start gap-2.5 group">
                ...
                <span className="mt-0.5 group-hover:text-blue-600 transition-colors">{contact.phone}</span>
              </li>
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-6 border-t border-gray-200/80 flex flex-col md:flex-row justify-between items-center gap-4 text-xs font-medium text-black">
          <p>
...
function FooterLink({ href, children }: FooterLinkProps) {
  return (
    <li>
      <Link
        href={href}
        className="group inline-flex items-center text-xs font-semibold text-black hover:text-blue-600 transition-all duration-300"
      >
